...
abstract class borders {
  static Border b_1px_primary = Border.all(color: AppColors.bmiTracker, width: 1);
  ...
  static Border b_1px_bgPrimary =
      Border.all(color: AppColors.bgPrimary, width: 1);
  static Border b_1px_bgLightBlue =
      Border.all(color: AppColors.bgLightBlue, width: 1);
  ...
  static Border bb_1px_primary = const Border(
      bottom: BorderSide(
